...
public class InternalUserControllerTest extends InternalIntegrationTest {
    @Autowired
    ...
    public void givenDataExists_whenGetSingleIsCalled_shouldReturnData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE first_name LIKE '%test%'");

        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/user/" + singleObject.get(0).get("id"),
                HttpMethod.GET,
                new HttpEntity<>(headers), String.class);
    ...
    public void givenValidData_whenPost_shouldCreateData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE email LIKE 'tester.blue@test.io'");
    ...
    public void givenValidData_whenPostList_shouldCreateAllData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE email = 'tester.blue@test.io'");
        assertEquals("Blue", singleObject.get(0).get("last_name"));

        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.user WHERE email = 'tester.green@test.io'");
        assertEquals("Green", singleObject.get(0).get("last_name"));

        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.user WHERE email = 'tester.orange@test.io'");
    ...
    public void givenValidData_whenPut_shouldCreateData() {
        ...
        singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE email = 'updated@test.io'");
    ...
    public void givenPartialData_whenPatch_shouldUpdate() {
        ...
        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/user/" + objectList.get(0).get("id"),
                HttpMethod.PATCH,
                new HttpEntity<>(data.toString(), headers),
                String.class);
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE first_name = 'Partial Update'");
    ...
    public void givenDataExists_whenDelete_shouldRemoveObject() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.user WHERE first_name = '" +
