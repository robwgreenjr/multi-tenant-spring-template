...
public class InternalPermissionControllerTest extends InternalIntegrationTest {
    @Autowired
    ...
    public void givenDataExists_whenGetSingleIsCalled_shouldReturnData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_permission WHERE name LIKE '%test%'");

        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/authorization/permission/" +
    ...
    public void givenInvalidData_whenGetSingleIsCalled_shouldReturn404() {
        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/authorization/permission/1",
                HttpMethod.GET,
                new HttpEntity<>(headers), String.class);
    ...
    public void givenValidData_whenPost_shouldCreateData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_permission WHERE name = 'Tester'");
    ...
    public void givenValidData_whenPostList_shouldCreateAllData() {
        ...
        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.authorization_permission WHERE name = 'TesterG'");
        assertEquals("Green", singleObject.get(0).get("type"));

        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.authorization_permission WHERE name = 'TesterO'");
    ...
    public void givenValidData_whenPut_shouldCreateData() {
        ...
        singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_permission WHERE name = 'Updated Name'");
    ...
    public void givenValidData_whenPutList_shouldCreateAllData() {
        ...
        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/authorization/permissions",
                HttpMethod.PUT,
                new HttpEntity<>(data.toString(), headers),
                String.class);
    ...
    public void givenPartialData_whenPatch_shouldUpdate() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_permission WHERE name = 'Partial Update'");
    ...
    public void givenDataExists_whenDelete_shouldRemoveObject() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_permission WHERE name = '" +
