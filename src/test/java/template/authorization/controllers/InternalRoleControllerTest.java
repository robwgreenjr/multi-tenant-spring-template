...
public class InternalRoleControllerTest extends InternalIntegrationTest {
    @Autowired
    ...
    public void givenDataExists_whenGetSingleIsCalled_shouldReturnData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_role WHERE name LIKE '%test%'");

        ResponseEntity<String> response =
            restTemplate.exchange(
                "/internal/authorization/role/" +
    ...
    public void givenValidData_whenPost_shouldCreateData() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_role WHERE name = 'Tester'");
    ...
    public void givenValidData_whenPostList_shouldCreateAllData() {
        ...
        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.authorization_role WHERE name = 'TesterG'");
        assertEquals(1, singleObject.size());

        singleObject = jdbcTemplate.queryForList(
            "SELECT * FROM internal.authorization_role WHERE name = 'TesterO'");
        assertEquals(1, singleObject.size());
    }
    ...
    public void givenValidData_whenPut_shouldCreateData() {
        ...
        singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_role WHERE name = 'Updated Name'");
        assertEquals(1, singleObject.size());
    }
    ...
    public void givenPartialData_whenPatch_shouldUpdate() {
        ...
        List<Map<String, Object>> singleObject =
            jdbcTemplate.queryForList(
                "SELECT * FROM internal.authorization_role WHERE name = 'Partial Update'");
        assertEquals(1, singleObject.size());
    }
