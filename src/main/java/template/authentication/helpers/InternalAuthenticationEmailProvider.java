...
@Service("InternalAuthenticationEmailProvider")
public class InternalAuthenticationEmailProvider
    implements AuthenticationEmailProvider<InternalResetPasswordToken> {
    ...
    public InternalAuthenticationEmailProvider(SESSender sesSender,
